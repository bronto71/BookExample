...
# 가우시안 노이즈를 추가하여 잡영이 많은 데이터를 만들기
...
tensorboard = TensorBoard(log_dir='./log', histogram_freq=0, write_grads=True, write_images=True)
model_saver = ModelCheckpoint(filepath='./check', verbose=0, period=2)
